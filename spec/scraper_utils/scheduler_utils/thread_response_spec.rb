...
RSpec.describe ScraperUtils::Scheduler::ThreadResponse do
  ...
  describe "#initialize" do
    it "creates a response with all fields" do
      # authority, result, error, time_taken
      response = described_class.new(authority, result, no_error, time_taken)
  ...
  describe "#success?" do
    ...
    it "returns false when there is an error" do
      ...
      response = described_class.new(authority, result, an_error, time_taken)
